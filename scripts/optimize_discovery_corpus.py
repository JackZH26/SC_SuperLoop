...
def classify(record: dict) -> dict:
    ...
    if rid == "track-b-e0-2026-06-25-0029":  # TiN
        ...
        defaults.update(explicit)
    elif formula in {"La2CuO4", "LaFeAsO", "BaFe2P2", "CaFe2As2", "SrFe2As2"}:
        explicit = {
            "La2CuO4": {
                "record_role": "conditional_candidate",
                "superconductivity_status": "condition_dependent_candidate",
                "novelty_class": "parent_state_comparator",
                "promotion_gate": "require_explicit_doping_context",
                "mechanism_risk": ["strong_correlation", "doping_required"],
                "claim_level": "conditional_candidate",
                "next_action": "keep_as_parent_cuprate_comparator_not_as_generic_novel_lead",
                "discovery_score_public": 36.0,
                "exclude_from_new_discovery_leaderboard": True,
            },
            "LaFeAsO": {
                ...
                "novelty_class": "parent_state_comparator",
                "promotion_gate": "require_explicit_doping_context",
                "mechanism_risk": ["spin_fluctuation", "doping_required", "magnetic_risk"],
                "claim_level": "conditional_candidate",
                "next_action": "keep_as_parent_1111_comparator_not_as_generic_novel_lead",
                "discovery_score_public": 35.0,
                "exclude_from_new_discovery_leaderboard": True,
            },
            "BaFe2P2": {
                "record_role": "conditional_candidate",
                "superconductivity_status": "condition_dependent_candidate",
                "novelty_class": "family_comparator",
                "promotion_gate": "require_family_context",
                "mechanism_risk": ["spin_fluctuation"],
                "claim_level": "conditional_candidate",
                "next_action": "use_as_iron_pnictide_comparator_not_as_standalone_novel_lead",
                "discovery_score_public": 35.0,
                "exclude_from_new_discovery_leaderboard": True,
            },
            "CaFe2As2": {
                "record_role": "conditional_candidate",
                "superconductivity_status": "condition_dependent_candidate",
                "novelty_class": "pressure_sensitive_comparator",
                "promotion_gate": "require_pressure_context",
                "mechanism_risk": ["spin_fluctuation", "pressure_sensitive"],
                "claim_level": "conditional_candidate",
                "next_action": "keep_as_pressure_sensitive_comparator_and_link_to_tuned_122_rows",
                "discovery_score_public": 34.0,
                "exclude_from_new_discovery_leaderboard": True,
            },
            "SrFe2As2": {
                ...
                "superconductivity_status": "condition_dependent_candidate",
                "novelty_class": "family_comparator",
                "promotion_gate": "require_explicit_doping_or_pressure_context",
                "mechanism_risk": ["spin_fluctuation", "doping_required"],
                "claim_level": "conditional_candidate",
                "next_action": "keep_as_122_family_comparator_not_as_generic_novel_lead",
                "discovery_score_public": 34.0,
                "exclude_from_new_discovery_leaderboard": True,
            },
        }[formula]
